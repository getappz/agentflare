...
impl Default for PricingTable {
    fn default() -> Self {
        ...
        models.insert(
            "claude-opus-4".into(),
            ModelPricing { input_per_mtok: 15.0, output_per_mtok: 75.0, cache_read_per_mtok: 1.5, cache_write_per_mtok: 18.75 },
        );
        models.insert(
            "claude-sonnet-4".into(),
            ModelPricing { input_per_mtok: 3.0, output_per_mtok: 15.0, cache_read_per_mtok: 0.3, cache_write_per_mtok: 3.75 },
        );
        models.insert(
            "claude-haiku".into(),
            ModelPricing { input_per_mtok: 0.8, output_per_mtok: 4.0, cache_read_per_mtok: 0.08, cache_write_per_mtok: 1.0 },
        );
        models.insert(
            "codex".into(),
            ModelPricing { input_per_mtok: 1.25, output_per_mtok: 10.0, cache_read_per_mtok: 0.125, cache_write_per_mtok: 0.0 },
        );
        models.insert(
            "gemini".into(),
            ModelPricing { input_per_mtok: 1.25, output_per_mtok: 10.0, cache_read_per_mtok: 0.31, cache_write_per_mtok: 0.0 },
        );
        models.insert(
            "kimi".into(),
            ModelPricing { input_per_mtok: 0.55, output_per_mtok: 2.20, cache_read_per_mtok: 0.15, cache_write_per_mtok: 0.0 },
        );
        Self {
            models,
            default: ModelPricing { input_per_mtok: 3.0, output_per_mtok: 15.0, cache_read_per_mtok: 0.3, cache_write_per_mtok: 3.75 },
        }
    }
}
