...
at all once something's cached, and your lookups never pass through a third party. For a
Rust, npm, or Python project, that adds up to fewer moving parts and nothing that can
rate-limit you or go down on you.
