...
mod dev_vars;
mod doctor;
use agentflare_bin_lib::dispatch_failure_ceiling;
use agentflare_bin_lib::errors;
...
mod mentions;
mod messages;
use agentflare_bin_lib::mise_install;
mod nudge_pace;
mod opencode_go_usage;
mod optimize;
use agentflare_bin_lib::paths;
mod pm_mode;
mod pricing;
mod progress;
...
mod skill_detect;
mod skill_proactive;
use agentflare_bin_lib::state;
use agentflare_bin_lib::store;
mod supervisor;
mod tool_install;
mod ui;
mod uninstall;
